...
def get_persistent_menu():
    return ReplyKeyboardMarkup(
        keyboard=[
            [
                KeyboardButton(text=TRANSLATIONS["ru"]["menu"]),
                KeyboardButton(text=TRANSLATIONS["ru"]["share_bot"]),
                KeyboardButton(text=TRANSLATIONS["ru"]["change_language"]),
                KeyboardButton(text=TRANSLATIONS["ru"]["donate"])
            ],
        ],
...
async def start(msg: Message):
    ...
    if not users[user_id].get("language"):
        ...
        await msg.answer(get_translation(user_id, "menu_appeared"), reply_markup=get_persistent_menu())
...
@dp.message(lambda m: m.text == TRANSLATIONS["ru"]["change_language"])
...
@dp.message(lambda m: m.text == TRANSLATIONS["ru"]["donate"])
...
@dp.message(lambda m: m.text == TRANSLATIONS["ru"]["menu"])
...
@dp.message(lambda m: m.text == TRANSLATIONS["ru"]["share_bot"])
async def share_bot_info(msg: Message):
    ...
    # Очищаем HTML-теги для текста кнопки
